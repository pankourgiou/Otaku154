...
qaList = [QA("Which of these bands is from Sweden?", "In Flames", ["Angra", "Metallica"]),
QA("Which of these bands is from Greece?", "Rotting Christ", ["In Flames", "Angra", "Iron Maiden"]),
QA("Which of these bands is from Germany?", "Helloween", ["In Flames", "Rotting Christ", "Slayer"]),
QA("Which of these bands is from Norway?", "Immortal", ["In Flames", "Rotting Christ"]),
QA("Which of these bands is French?", "Gojira", ["Immortal", "In Flames", "Slayer", "Pantera"])]
